...
})(
  {
      ...
      function (require, module, exports) {
        ...
        (function (name, root, factory) {
          ...
          function replace(string, options) {
            ...
            var slug = string
              .normalize()
              .split("") // replace characters based on charMap
              .reduce(function (result, ch) {
                ...
                return (
                  result +
                  appendChar // remove not allowed characters
    ...
    "alert.js": [
      function (require, module, exports) {
        ...
        var showModal = function showModal() {
          var markup =
            '<div class="modal alert--error"><p>Confirm Delete?</p><div class="btn-container"><button class="btn-small btn--white js__btn">Cancel</button><button class="btn-small btn--green js__btn">Confirm</button></div></div><div class="overlay"></div>';
          disableScroll();
          document
            .querySelector("body")
            .insertAdjacentHTML("afterbegin", markup);
      ...
      function (require, module, exports) {
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 10:
                        ...
                        (0, _alert.showAlert)(
                          "error",
                          "Error when trying to log out. Please try again!"
                        );
        ...
        var forgotPassword = /*#__PURE__*/ (function () {
          var _ref4 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee4(email) {
              var res, data;
              return regeneratorRuntime.wrap(
                  ...
                  while (1) {
                    switch ((_context5.prev = _context5.next)) {
                      case 0:
                        ...
                        _context5.next = 3;
                        return fetch(
                          "/api/v1/users/reset-password/".concat(token),
                          {
                            method: "PATCH",
                            headers: {
                              "Content-Type": "application/json"
        ...
        var displayMap = function displayMap(locations) {
          ...
          locations.forEach(function (loc) {
            ...
            new mapboxgl.Popup({
              ...
              .addTo(map); // Key: Extend the map bounds to include  current location (cover/include the current location in the map bound area.)
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        _context.next = 3;
                        return fetch(
                          "/api/v1/tours/".concat(tourId, "/reviews"),
                          {
                            method: "POST",
                            headers: {
                              "Content-Type": "application/json"
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        ...
                        return fetch(
                          selectedTour
                            ? "/api/v1/tours/".concat(selectedTour, "/reviews")
                            : "/api/v1/reviews",
                          {
                            method: "GET",
                            headers: {
                      ...
                      case 6:
                        ...
                        markup = data.data.doc.reduce(function (markup, d) {
                          return (markup =
                            markup +
                            '<div class="card" data-review-id='
                              .concat(
                                d.id,
                                '><button class="button">X</button><input class="onlycb checkbox" type="checkbox"><div class="card__header"><div class="card__picture"><div class="card__picture-overlay">&nbsp;</div><img class="card__picture-img" src="/img/tours/'
                              )
                              .concat(d.tour.imageCover, '" alt=')
                              .concat(
                                d.tour.name,
                                '></div><h3 class="heading-tertirary"><span>'
                              )
                              .concat(
                                d.tour.name,
                                '</span></h3></div><div class="card__details"><h4 class="card__sub-heading">Review</h4><p class="card__text">'
                              )
                              .concat(
                                d.review,
                                '</p></div><div class="card__footer"><p><span class="card__footer-text">User -</span> <span class="card__footer-value">'
                              )
                              .concat(
                                d.user.name,
                                '</span></p><p class="card__ratings"><span class="card__footer-text">Rating -</span> <span class="card__footer-value">'
                              )
                              .concat(d.rating, "</span></p></div></div>"));
                        }, "");
      ...
      function (require, module, exports) {
        ...
        var getTourData = function getTourData() {
          ...
          form.append(
            "locations",
            JSON.stringify(
              Array.from(document.querySelectorAll(".location")).map(function (
                loc
              ) {
          ...
          form.append(
            "startDates",
            JSON.stringify(
              Array.from(document.querySelectorAll(".startDate")).map(function (
                date
              ) {
          ...
          form.append(
            ...
            document.getElementById("image1").files[0] ||
              document.querySelector("#image1").nextElementSibling.textContent
          );
          form.append(
            "images",
            document.getElementById("image2").files[0] ||
              document.querySelector("#image2").nextElementSibling.textContent
          );
          form.append(
            "images",
        ...
        var manageModel = /*#__PURE__*/ (function () {
          ...
          _createClass(manageModel, [
                        ...
                        while (1) {
                          switch ((_context.prev = _context.next)) {
                            case 0:
                              ...
                              _context.next = 3;
                              return fetch(
                                "/api/v1/".concat(this.collection, "/delete"),
                                {
                                  method: "DELETE",
                                  headers: {
                                    "Content-Type": "application/json"
            ...
            },
            {
              key: "createUpdate",
              value: (function () {
                var _createUpdate = _asyncToGenerator(
                  /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(
                    userData
                  ) {
                    var _this = this;
                            ...
                            case 13:
                              ...
                              setTimeout(function () {
                                return location.assign(
                                  "/manage-".concat(_this.collection)
                                );
                              }, 2000);
                              _context2.next = 20;
                              break;
    ...
    "paginate.js": [
      function (require, module, exports) {
        ...
        var lastPage = +((_document$querySelect =
          document.querySelector(".last")) === null ||
        _document$querySelect === void 0
          ? void 0
          : _document$querySelect.dataset.page);
                        ...
                        while (1) {
                          switch ((_context.prev = _context.next)) {
                            case 0:
                              ...
                              _context.next = 10;
                              return fetch(
                                "/api/v1/users?role[ne]=admin&page=".concat(
                                  currentPage,
                                  "&limit=12"
                                )
                              );
                              ...
                              data.data.doc.forEach(function (d) {
                                markup =
                                  ...
                                  '\n                        <div class="card" data-user-id="'
                                    .concat(
                                      d._id,
                                      '"><button class="button">X</button><a href="/update-user/'
                                    )
                                    .concat(
                                      d._id,
                                      '"><svg class="edit__icon"><use xlink:href="img/icons.svg#icon-edit"></use></svg></a><input class="checkbox" type="checkbox"><div class="card__header"><div class="card__picture"><img class="card__picture-img" src="/img/users/'
                                    )
                                    .concat(d.photo, '" alt="Photo of ')
                                    .concat(
                                      d.name,
                                      '"></div><h3 class="heading-quaternary"><span>'
                                    )
                                    .concat(
                                      d.name,
                                      '</span></h3></div><div class="card__footer"><p><span class="card__footer-value">'
                                    )
                                    .concat(
                                      d.email,
                                      '</span> <span class="card__footer-text"></span></p><p class="card__ratings"><span class="card__footer-value">'
                                    )
                                    .concat(d.role, "</span></p></div></div>");
                              });
    ...
    "index.js": [
      function (require, module, exports) {
                      ...
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          document.querySelector(
                            ".btn--save-password"
                          ).textContent = "Updating..."; // Warning: Never use innerHTML because it will lead to XSS. value is only available to input elements!
        ...
        if (tourForm) {
          ...
          tourForm.addEventListener("submit", function (e) {
            ...
            if (location.pathname.startsWith("/update-tour"))
              return new _manageModel.default("tours").createUpdate(
                formData,
        ...
        var deleteTour = function deleteTour() {
          ...
          var tourId =
            (_document$querySelect = document.querySelector(".card")) ===
              null || _document$querySelect === void 0
              ? void 0
              : _document$querySelect.dataset.tourId;
          if (!tourId) return;
          ...
          deleteSelected.addEventListener("click", function () {
            if (document.querySelectorAll(".checkbox:checked").length === 0)
              return (0, _alert.showAlert)("error", "Please Select First!", 2);
            var tourIds = [];
            var tourSlugs = [];
            document
        ...
        if (userForm) {
          userForm.addEventListener("submit", function (e) {
            ...
            return new _manageModel.default("users").createUpdate(
              JSON.stringify({
                role: role
              }),
              location.pathname.slice(location.pathname.lastIndexOf("/") + 1)
        ...
        var deleteUser = function deleteUser() {
          ...
          var userId =
            (_document$querySelect2 = document.querySelector(".card")) ===
              null || _document$querySelect2 === void 0
              ? void 0
              : _document$querySelect2.dataset.userId;
          if (!userId) return;
          var deleteBtns = document.querySelectorAll(".button");
          var deleteSelected = document.getElementById("delete-selected");
          deleteBtns.forEach(function (btn) {
        ...
        var deleteReview = function deleteReview() {
          ...
          var reviewId =
            (_document$querySelect3 = document.querySelector(".card")) ===
              null || _document$querySelect3 === void 0
              ? void 0
              : _document$querySelect3.dataset.reviewId;
          if (!reviewId) return;
          var deleteBtns = document.querySelectorAll(".button");
          var deleteSelected = document.getElementById("delete-selected");
          deleteBtns.forEach(function (btn) {
          ...
          deleteSelected === null || deleteSelected === void 0
            ? void 0
            : deleteSelected.addEventListener("click", function () {
                if (document.querySelectorAll(".checkbox:checked").length === 0)
                  return (0, _alert.showAlert)(
                    "error",
                    "Please Select First!",
                    2
                  );
        ...
        var deleteBooking = function deleteBooking() {
          ...
          var bookingId =
            (_document$querySelect4 = document.querySelector(".card")) ===
              null || _document$querySelect4 === void 0
              ? void 0
              : _document$querySelect4.dataset.bookingId;
          if (!bookingId) return;
          var deleteBtns = document.querySelectorAll(".button");
          var deleteSelected = document.getElementById("delete-selected");
          deleteBtns.forEach(function (btn) {
        ...
        if (bookingForm) {
          bookingForm.addEventListener("submit", function (e) {
            ...
            var createBooking =
              ...
              "Create Booking";
            if (createBooking)
              return new _manageModel.default("bookings").createUpdate(
                JSON.stringify({
                  email: email,
                  tourName: tourName,
                  price: price,
        ...
        if (forgotForm) {
          document
            ...
            .addEventListener("click", function (e) {
              e.preventDefault();
              (0,
              _loginSignup.forgotPassword)(document.getElementById("email").value);
            });
        }
      ...
      },
      {
        ...
        "core-js/modules/web.dom.iterable.js":
          "../../node_modules/core-js/modules/web.dom.iterable.js",
        slugify: "../../node_modules/slugify/slugify.js",
        "regenerator-runtime/runtime.js":
          "../../node_modules/regenerator-runtime/runtime.js",
        "./loginSignup": "loginSignup.js",
        "./mapbox": "mapbox.js",
