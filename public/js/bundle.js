      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 10:
            ...
            (0, _alert.showAlert)("error", "Error when trying to sign up. Please try again!");
...
if (resetForm) {
  document.querySelector(".btn").addEventListener("click", function (e) {
    e.preventDefault();
    (0, _loginSignup.resetPassword)(document.getElementById("email").value);
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "45387" + '/');
