...
var manageModel = /*#__PURE__*/function () {
  function manageModel(collection, docId) {
...
},{"./alert":"alert.js"}],"alert.js":[function(require,module,exports) {
"use strict";
...
var hideModal = function hideModal(tourId) {
  document.querySelectorAll(".js__btn").forEach(function (el) {
    return el.addEventListener("click", function (e) {
      ...
      tourId.constructor === Array ? new _manageModel.default("tours", tourId).deleteMultiple() : new _manageModel.default("tours", tourId).deleteOne();
    });
  });
}; // Part: Show Modal
...
var showModal = function showModal(tourId) {
...
},{"./manageModel":"manageModel.js"}],"loginSignup.js":[function(require,module,exports) {
"use strict";
...
var deleteSelected = document.getElementById("delete-selected"); // Chapter: Delegation
...
if (deleteBtns) {
  deleteBtns.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      (0, _alert.showModal)(e.target.parentElement.dataset.tourId);
    });
  });
}
