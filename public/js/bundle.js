...
exports.showModal = exports.showAlert = exports.hideModal = exports.hideAlert = void 0;
...
var showModal = function showModal() {
  var markup = "<div class=\"modal alert--error\"><p>Confirm Delete?</p><div class=\"btn-container\"><button class=\"btn-small btn--white js__btn\">Cancel</button><button class=\"btn-small btn--green js__btn\">Confirm</button></div></div><div class=\"overlay\"></div>";
  disableScroll();
  document.querySelector("body").insertAdjacentHTML("afterbegin", markup);
};

exports.showModal = showModal;
},{}],"loginSignup.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            (0, _alert.showAlert)("error", "Error when trying to log out. Please try again!");
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            if (data.status === "success") {
              (0, _alert.showAlert)("success", "Account created successfully! Now please check your Email to activate and log into your account!");
              setTimeout(function () {
                location.assign("/");
              }, 5000);
            }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return fetch("/api/v1/users/forgot-password", {
              method: "POST",
              headers: {
                "Content-Type": "application/json"
              },
          ...
          case 6:
            ...
            if (data.status === "success") {
              (0, _alert.showAlert)("success", data.message);
              setTimeout(function () {
                location.assign("/");
              }, 3000);
            }
          ...
          case 10:
            ...
            (0, _alert.showAlert)("error", "Failed to send password reset link!");
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return fetch("/api/v1/users/reset-password/".concat(token), {
              method: "PATCH",
              headers: {
                "Content-Type": "application/json"
              },
          ...
          case 10:
            ...
            (0, _alert.showAlert)("error", "Failed to reset your password!");
...
},{"./alert":"alert.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    }).setLngLat(loc.coordinates).addTo(map); // Key: App Popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Key: Extend the map bounds to include  current location (cover/include the current location in the map bound area.)
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(settings, type) {
    var url, res, data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var stripe = Stripe("pk_test_51KoMC0CUGtQvOzQdZv6lb3Lgbf6scxHV1uMyvHfOW47PHpSNdbzFcWyiGXdU0H1ROZx26dhwECinUtGiMpSW6mvR00p5vVUI6o"); // Warning: Can not use catchAsync here because that's for backend cause that requires req, res and next() which is not available in frontend.
...
},{"./alert":"alert.js"}],"review.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.submitReview = exports.showReviews = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("/api/v1/tours/".concat(tourId, "/reviews"), {
              method: "POST",
              headers: {
                "Content-Type": "application/json"
              },
          ...
          case 6:
            ...
            (0, _alert.showAlert)("success", "Your review was submitted successfully.");
            setTimeout(function () {
              location.reload();
            }, 2000);
            _context.next = 13;
...
var showReviews = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(selectedTour) {
    var res, data, markup;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch(selectedTour ? "/api/v1/tours/".concat(selectedTour, "/reviews") : "/api/v1/reviews", {
              method: "GET",
              headers: {
                "Content-Type": "application/json"
              }
          ...
          case 6:
            ...
            //     location.reload();
            // }, 2000);
            markup = data.data.doc.reduce(function (markup, d) {
              return markup = markup + "<div class=\"card\" data-review-id=".concat(d.id, "><button class=\"button\">X</button><input class=\"onlycb checkbox\" type=\"checkbox\"><div class=\"card__header\"><div class=\"card__picture\"><div class=\"card__picture-overlay\">&nbsp;</div><img class=\"card__picture-img\" src=\"/img/tours/").concat(d.tour.imageCover, "\" alt=").concat(d.tour.name, "></div><h3 class=\"heading-tertirary\"><span>").concat(d.tour.name, "</span></h3></div><div class=\"card__details\"><h4 class=\"card__sub-heading\">Review</h4><p class=\"card__text\">").concat(d.review, "</p></div><div class=\"card__footer\"><p><span class=\"card__footer-text\">User -</span> <span class=\"card__footer-value\">").concat(d.user.name, "</span></p><p class=\"card__ratings\"><span class=\"card__footer-text\">Rating -</span> <span class=\"card__footer-value\">").concat(d.rating, "</span></p></div></div>");
            }, "");
            document.querySelector(".card-container").innerHTML = markup || "\"\"<h1 style=\"text-align:center;\">No Reviews Found!</h1>";
            (0, _.deleteReview)();
            _context2.next = 14;
            break;
  ...
  return function showReviews(_x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.showReviews = showReviews;
},{"./alert":"alert.js",".":"index.js"}],"tour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getTourData = void 0;

var getTourData = function getTourData() {
  ...
  form.append("locations", JSON.stringify(Array.from(document.querySelectorAll(".location")).map(function (loc) {
    var data = loc.value.split("|");
    return {
...
},{}],"manageModel.js":[function(require,module,exports) {
"use strict";
...
var manageModel = /*#__PURE__*/function () {
  function manageModel(collection, docId, tourSlug) {
    _classCallCheck(this, manageModel);
  ...
  _createClass(manageModel, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 15:
                _context.prev = 15;
                _context.t0 = _context["catch"](0);
                (0, _alert.showAlert)("error", _context.t0.message, 2);
    ...
    key: "createUpdate",
    value: function () {
      var _createUpdate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(userData) {
        var _this = this;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                docId = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : null;
                _context2.prev = 1;
              ...
              case 8:
                _context2.next = 10;
                return fetch("/api/v1/".concat(this.collection, "/").concat(docId), {
                  method: "PATCH",
                  headers: this.collection === "users" || "bookings" ? {
                    "Content-Type": "application/json"
                  } : {},
                  body: userData
                });
              ...
              case 13:
                ...
                setTimeout(function () {
                  return location.assign("/manage-".concat(_this.collection));
                }, 2000);
                _context2.next = 20;
                break;
      ...
      function createUpdate(_x) {
        return _createUpdate.apply(this, arguments);
      }
...
exports.deleteUser = exports.deleteTour = exports.deleteReview = exports.deleteBooking = void 0;
...
var photoes = document.querySelectorAll(".photo");
...
var select = document.querySelector("select"); // Chapter: Delegation
...
if (photoes) {
  photoes.forEach(function (photo) {
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    (0, _loginSignup.signup)(name, email, password, passwordConfirm);
  });
}
...
if (reviewBtn) {
  reviewBtn.addEventListener("submit", function (e) {
    e.preventDefault();
    var tourId = location.pathname.slice(1).split("/")[0];
...
var deleteTour = function deleteTour() {
  ...
  deleteBtns.forEach(function (btn) {
    btn.addEventListener("click", function (event) {
      (0, _alert.showModal)();
      var tourSlug = slugify(event.target.parentElement.querySelector(".heading-tertirary span").textContent, {
        replacement: "",
        lower: true
      });
      document.querySelectorAll(".js__btn").forEach(function (el) {
        return el.addEventListener("click", function (e) {
          ...
          new _manageModel.default("tours", event.target.parentElement.dataset.tourId, tourSlug).delete();
        });
      });
    });
  });
  deleteSelected.addEventListener("click", function () {
    ...
    document.querySelectorAll(".checkbox:checked").forEach(function (el) {
      ...
      tourSlugs.push(slugify(el.closest(".card").querySelector(".heading-tertirary span").textContent, {
        replacement: "",
        lower: true
      }));
    });
    ...
    document.querySelectorAll(".js__btn").forEach(function (el) {
      return el.addEventListener("click", function (e) {
        (0, _alert.hideModal)();
        if (e.target.textContent !== "Confirm") return;
        new _manageModel.default("tours", tourIds, tourSlugs).delete();
      });
    });
  });
};
...
if (select) {
  select.addEventListener("change", function () {
    var selectedTour = document.querySelector("select").selectedOptions[0].value;
    (0, _review.showReviews)(selectedTour);
  });
}
...
deleteReview(); // Chapter: Booking

var deleteBooking = function deleteBooking() {
  var _document$querySelect4;

  var bookingId = (_document$querySelect4 = document.querySelector(".card")) === null || _document$querySelect4 === void 0 ? void 0 : _document$querySelect4.dataset.bookingId;
  if (!bookingId) return;
  var deleteBtns = document.querySelectorAll(".button");
  var deleteSelected = document.getElementById("delete-selected");
  deleteBtns.forEach(function (btn) {
    btn.addEventListener("click", function (event) {
      ...
      document.querySelectorAll(".js__btn").forEach(function (el) {
        return el.addEventListener("click", function (e) {
          (0, _alert.hideModal)();
          if (e.target.textContent !== "Confirm") return;
          new _manageModel.default("bookings", event.target.parentElement.dataset.bookingId).delete();
        });
      });
    });
  });
  deleteSelected.addEventListener("click", function () {
    ...
    document.querySelectorAll(".js__btn").forEach(function (el) {
      return el.addEventListener("click", function (e) {
        (0, _alert.hideModal)();
        if (e.target.textContent !== "Confirm") return;
        new _manageModel.default("bookings", bookingIds).delete();
      });
    });
  });
};
...
if (forgotForm) {
  document.querySelector(".btn").addEventListener("click", function (e) {
    e.preventDefault();
    (0, _loginSignup.forgotPassword)(document.getElementById("email").value);
  });
}
