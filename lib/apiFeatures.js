class APIFeatures {
    ...
    sort() {
        if (this.initialQuery.sort) {
            ...
            this.query = this.query.sort("_id -createdAt"); // Important: MongoDB does not store documents in a collection in a particular order. So to prevent duplicate results must use atleast one unique field.
        }
